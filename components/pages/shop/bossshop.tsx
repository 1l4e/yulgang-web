import { findManyBossShop } from "@/models/shop.server"
...
const BossShop = async ({params,searchParams}) => {
    ...
    const data = await findManyBossShop(50,page)
  ...
  return (
    <div className="container mx-auto">
      <h1 className="text-3xl text-center py-4">BOSS SHOP</h1>
